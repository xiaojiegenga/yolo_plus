"""Focused tests for the V3 BCE + Dice instance-mask loss."""
...
def test_zero_dice_gain_matches_legacy_bce_exactly() -> None:
...
def test_combined_mask_loss_has_finite_gradients_and_preserves_target() -> None:
    ...
    loss = v8SegmentationLoss.single_mask_loss(
        ...
        boxes,
        areas,
        dice_gain=v8SegmentationLoss.INSTANCE_DICE_GAIN,
        dice_smooth=v8SegmentationLoss.INSTANCE_DICE_SMOOTH,
    )
    loss.backward()
