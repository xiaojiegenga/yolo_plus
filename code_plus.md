...
**训练状态**: ✅ 训练完成 (2026-06-30) | Best epoch: 250 (early stop 350) | 3.51h
...
| | | | |
| Params(M) | 21.78 | 27.83 | +6.05M* |

> *参数量增加主要来自分割头 (Segment26 比 Detect 多 proto mask 分支)，CBAM 本身仅 +0.85M。训练均使用 m 尺度。
>
> **结论**: CBAM 带来全面小幅提升。钻心虫 (+3pp) 受益最明显。卷叶螟漏检率从 52% 降到 45%，但 AP50 几乎不变 — 说明 CBAM 帮 Recall 到了容易的样本，极小的虫子仍需 P2 高分辨率层。
...
|---|---|---|---|---|---|---|---|---|---|
| Baseline | 0.717 | 0.620 | **0.683** | 0.329 | 0.604/0.679/0.482 | 0.763/0.753/0.755 | 52% | 21.78 | 74.7 |
| v1 CBAM | 0.753 | 0.633 | **0.700** | 0.343 | 0.607/0.662/0.552 | 0.793/0.844/0.714 | 45% | 27.83 | 121.9 |
| v2 P2 | ? | ? | ? | ? | ? | ? | ? | ? | ? |
| v3 Dice | ? | ? | ? | ? | ? | ? | ? | ? | ? |
| v4 Combined | ? | ? | ? | ? | ? | ? | ? | ? | ? |
