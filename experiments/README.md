...
- C 分支的 `data-v2-abl-001-p2head-b16-s42.yaml`：轻量 P2Head 单因素配置；本地验证通过，待云端预检与正式训练。该配置与 C 源码在 `feature/data-v2-abl-c-p2head` 维护。
...
改变对应源码结构或损失因素，并使用新的 Run ID。000、A1、A2、B 已完成；当前 C 代码与
本地验证已完成，云端操作按根目录 `实验步骤.md` 执行。
