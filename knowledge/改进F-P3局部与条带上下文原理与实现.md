...
状态：2026-09-13 正式训练已完成；Val Mask mAP50-95=0.35882，较 Baseline -0.00466，当前不进入 D1+F。完整结果与机制分析见 [F 正式记录](../experiment_records/runs/data-v2-abl-f-p3strip-b16-s42.md)。
