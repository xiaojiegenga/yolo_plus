...
- 正式配置：`experiments/data-v2-abl-d1-p2proto-b16-s42.yaml`；全部 33 项 train 参数与 000 相同。
- 模型构建前设置 seed=42；官方权重迁移与 2 类重建入口为 `scripts/check_p2proto.py`。
- 源码提交 `4b66461`；8 项聚焦测试及官方权重迁移通过。正式 Run `data-v2-abl-d1-p2proto-b16-s42` 待运行；操作入口见 `实验步骤.md`。
- 本地 8 项聚焦测试及官方权重迁移通过；源码提交 `4b66461`。2 类 fused Params=23,671,186，GFLOPs@640=135.431782。
